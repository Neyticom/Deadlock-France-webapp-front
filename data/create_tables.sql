...
DROP TABLE IF EXISTS "role", "user", "patchnote", "patchnote_publishers", "ressource", "hero", "spell", "spell_effect", "item", "item_effect", "keyword", "log", "statistic", "setting", "patchnote_entry";
DROP TYPE IF EXISTS "patchnote_state", "item_category", "patchnote_entry_category", "effect_type", "log_action", "statistic_type", "setting_type";
...
CREATE TABLE "spell" (
    "hero_id" INTEGER NOT NULL REFERENCES "ressource"(id) ON DELETE CASCADE,
...
CREATE TABLE "spell_effect" (
    "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "spell_id" INTEGER NOT NULL REFERENCES "ressource"(id) ON DELETE CASCADE,
    "order" INTEGER NOT NULL,
...
CREATE TABLE "item" (
    ...
    "child_id" INTEGER REFERENCES "ressource"(id)
) INHERITS ("ressource");
...
CREATE TABLE "item_effect" (
    "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "item_id" INTEGER NOT NULL REFERENCES "ressource"(id) ON DELETE CASCADE,
