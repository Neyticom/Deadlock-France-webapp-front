...
DROP TABLE IF EXISTS "role", "user", "patchnote", "patchnote_publishers", "hero", "spell", "spell_effect", "item", "item_effect", "keyword", "log", "statistic", "setting";
...
CREATE TABLE "patchnote" (
    ...
    "author" VARCHAR(64),
    "content" TEXT,
    "state" VARCHAR(10) NOT NULL CHECK ("state" IN ('DRAFT', 'PUBLISHED', 'ARCHIVED'))
);
...
CREATE TABLE "item" (
    "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "category" VARCHAR(10) NOT NULL CHECK ("category" IN ('WEAPON', 'VITALITY', 'SPIRIT')),
    "name" VARCHAR(64) NOT NULL UNIQUE,
...
CREATE TABLE "item_effect" (
    ...
    "type" VARCHAR(10) NOT NULL CHECK ("type" IN ('COMMON', 'ACTIVE', 'PASSIVE')),
    "effect" VARCHAR(192) NOT NULL
);

CREATE TABLE "keyword" (
    "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "entity_type" VARCHAR(10) NOT NULL CHECK ("entity_type" IN ('HERO', 'ITEM', 'SPELL')),
...
CREATE TABLE "log" (
    "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "action" VARCHAR(10) NOT NULL CHECK ("action" IN ('LOGIN', 'CREATE', 'DELETE', 'EDIT')),
    "context" TEXT,
...
CREATE TABLE "statistic" (
    ...
    "type" VARCHAR(10) NOT NULL CHECK ("type" IN ('VIEW', 'CLICK'))
);
...
CREATE TABLE "setting" (
    ...
    "value" TEXT,
    "type" VARCHAR(10) NOT NULL CHECK ("type" IN ('URL', 'PATH', 'TEXT'))
);
