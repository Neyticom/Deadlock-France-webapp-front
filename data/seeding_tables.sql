...
(3, 1, 'Deals 50 damage to all enemies.'),
(3, 2, 'Burns enemies for 5 seconds.');

INSERT INTO "item" ("name", "category", "cost", "common_bonus", "active_description", "active_duration", "passive_description", "passive_duration", "child_id") VALUES
...
(4, 'COMMON', 'Bonus +10 attack.'),
(5, 'ACTIVE', 'Grants 200 shield points.');

INSERT INTO "patchnote_entry" ("patchnote_id", "category", "ressource_id", "position", "description") VALUES
(1, 'BUFF', 3, 1, 'Increased fireball damage by 10%.'),
(2, 'FIX', 4, 2, 'Resolved texture clipping issue with Sword of Destiny.');

INSERT INTO "keyword" ("ressource_id", "value") VALUES
(1, 'Tank'),
(3, 'Fire'),
(4, 'Weapon');
...
('CREATE', 'Patchnote created.', 3, '192.168.1.2');
